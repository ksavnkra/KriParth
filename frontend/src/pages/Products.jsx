        ...
        <div className="overflow-x-auto">
          ...
          {filtered.length === 0 && (
            <div className="flex flex-col items-center justify-center py-24 text-center">
              <div className="w-20 h-20 rounded-full bg-teal-50 flex items-center justify-center mb-4"><Package className="w-10 h-10 text-teal-400" /></div>
              <p className="text-zinc-500 font-medium mb-1">No products yet</p>
              <p className="text-zinc-400 text-sm mb-4">Add your first product to get started</p>
              <button onClick={openAdd} className="px-4 py-2 rounded-xl bg-gradient-to-r from-teal-500 to-emerald-500 text-white text-sm font-semibold shadow-brand hover:shadow-lg transition-all">+ Add Product</button>
            </div>
          )}
        </div>
      </div>
